...
<c:if test="<%= PortletPropsValues.NOTIFICATIONS_DOCKBAR_DISPLAY_ENABLED %>">
	...
	<%
	int newUserNotificationsCount = UserNotificationEventLocalServiceUtil.getDeliveredUserNotificationEventsCountByType(themeDisplay.getUserId(), UserNotificationDeliveryConstants.TYPE_WEBSITE, false);
	int unreadUserNotificationsCount = UserNotificationEventLocalServiceUtil.getArchivedUserNotificationEventsCountByType(themeDisplay.getUserId(), UserNotificationDeliveryConstants.TYPE_WEBSITE, false);
	%>
